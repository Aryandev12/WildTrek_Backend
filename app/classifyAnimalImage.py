...
with open("WildTrek_Backend/app/static/animal_image.json", "r") as f:
...
animal_image_checkpoint = torch.load("WildTrek_Backend/app/models/animal_image_checkpoint.pth.tar", weights_only=False, map_location=device)
animal_image_model = torch.load("WildTrek_Backend/app/models/animal_image.pth", map_location=device, weights_only=False)
